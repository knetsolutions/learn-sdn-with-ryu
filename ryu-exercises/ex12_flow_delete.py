...
Openflow specification 1.3.2 reference page:
page 35
...
class SimpleSwitch13(app_manager.RyuApp):
    ...
    def delete_all_flows(self, datapath):
        print "getting in to delete flows ", datapath.id
        ofproto = datapath.ofproto
        parser = datapath.ofproto_parser
        ...
        mod = parser.OFPFlowMod(datapath=datapath,  
                                ...
                                flags=ofproto.OFPFF_SEND_FLOW_REM, match=empty_match, instructions=[])
    ...
    def _packet_in_handler(self, ev):
        ...
        if out_port != ofproto.OFPP_FLOOD:
            ...
            if eth.ethertype == ether_types.ETH_TYPE_IP:
                ...
                dstip = ip.dst
                protocol = ip.proto
                if srcip == "10.1.1.3" and dstip == "10.1.1.4" and protocol == in_proto.IPPROTO_ICMP:
